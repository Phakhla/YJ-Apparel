...
//Search Product
WebUI.setText(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/input_search'), searchText)
...
WebUI.verifyTextPresent(searchText, false)
