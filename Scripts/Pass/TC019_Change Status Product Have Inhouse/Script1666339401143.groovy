...
//Search Product
WebUI.setText(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/input_search'), '000-green-l')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/Warning Product Have Inhouse'), 5)
