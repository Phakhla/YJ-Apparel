...
//Search Product
WebUI.setText(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/input_search'), '0002-green-l')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/Warning Product is Component of Another'), 5)
