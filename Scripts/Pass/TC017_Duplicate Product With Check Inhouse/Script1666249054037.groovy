...
WebUI.verifyTextPresent('Product was successfully created.', false)
...
WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/button_Duplicate'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/Warning Duplicate Confirm'), 5)

WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/a_Comfirm Duplicate'))

WebUI.verifyTextPresent("Copy Detail", false)

WebUI.setText(findTestObject('Master Data/Product_Data_SKU/Add New Product/input_Color_productcolor'), 'Red')

WebUI.setText(findTestObject('Master Data/Product_Data_SKU/Add New Product/textarea_Color Description Thai_productcolor_descrip'), 'สีแดง')

WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_Create_commit'))

WebUI.verifyTextPresent('Product was successfully created.', false) // boolean พิสูจน์ว่าเป็นนิพจน์ทั่วไปหรือไม่
