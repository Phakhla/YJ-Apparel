...
WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/h2_Product List'), 5)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/Inhouse_Yes'), 5)

WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/a_View Detail'))

//Verify Text = 0 

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_Ironing'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_labeling_bagging_cost'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_OVH'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_Mark_up'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_Wholesale_profit'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_B2C'), 'value', '0.00', 5)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Master Data/Product_Data_SKU/Add New Product/input_USD'), 'value', '0.00', 5)
