...
//Double Click Inhouse
WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/a_Inhouse'))
WebUI.click(findTestObject('Object Repository/Master Data/Product_Data_SKU/01 Element/a_Inhouse'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Master Data/Product_Data_SKU/Product Info/Warning Inactive Comfirm'), 5)

WebUI.click(findTestObject('null'))

WebUI.verifyTextPresent('Product was successfully inactive.', false)
